      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          ...
          <nav className={styles.nav} aria-label="Navegación principal">
            <a href="#core-os">Infraestructura</a>
            <a href="#diagnostico">Diagnostic Engine</a>
            <a href="#para-quien">Ecosistema</a>
        ...
        <div className={styles.container}>
          <div className={styles.heroGrid}>
            <div className={styles.heroCopy}>
              <p className={styles.kicker}>Sports Decision Infrastructure · Data Trust</p>
              <h1>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.thesisGrid}>
            <div className={styles.thesisStatement}>
              <p>
                El problema no es disponer de información. Es convertirla en
                una capacidad permanente para operar y decidir.
              </p>
            </div>
            <div className={styles.thesisBody}>
              <p><strong>01 · Información distribuida.</strong> Datos, vídeos, documentos, métricas y observaciones viven en sistemas, archivos y personas diferentes.</p>
              <p><strong>02 · Protocolos e información desconectados.</strong> La organización puede saber cómo quiere operar sin disponer automáticamente de toda la información que ese proceso necesita.</p>
              <p><strong>03 · Coordinación manual.</strong> Cuando falta algo, alguien debe detectarlo, localizar al responsable, pedirlo, comprobarlo y reconstruir posteriormente qué ocurrió.</p>
              <p className={styles.emphasis}>
                TalentDrop convierte esa fragmentación en infraestructura operativa: información conectada con protocolos, responsables, evidencias y contexto.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={styles.darkSection} id="como-funciona">
        <div className={styles.container}>
          ...
          <div className={styles.decisionFlow}>
            {[
              ["Información", "Datos, documentos y conocimiento humano"],
              ["Protocolos", "Qué debe existir y quién interviene"],
              ["Data Trust", "Origen, contexto, evidencia y trazabilidad"],
              ["Coordinación", "Pendientes, responsables y validaciones"],
              ["Decisiones", "Preparadas antes de llegar a la mesa"],
        ...
        <div className={styles.container}>
          <div className={styles.finalGrid}>
            ...
            <div>
              ...
              <p>
                Empezamos con un diagnóstico breve para entender cómo circula la
                información, qué protocolos existen y qué debe ordenarse primero.
              </p>
              <a
