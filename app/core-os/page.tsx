...
export default function CoreOS() {
  return (
    <PageShell>
      <Hero eyebrow="TalentDrop Core OS" title="Cinco capas. Una única infraestructura." text="La arquitectura que conecta identidad, evidencia, seguridad, contexto y gobernanza médico-deportiva para apoyar mejores decisiones." image="/img/home-hero.jpg" />
